...
- DNS по умолчанию резолвится на стороне exit node через зашифрованный
  туннель (любой сервер, IP или доменное имя), либо локально на устройстве
  по выбору;
- зашифрованная проверка задержки, живой график пинга и страна выходной
  ноды, как только она становится известна;
